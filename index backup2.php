	  ...
	  <div class='col-md-12' style='background-color: #333;'>
			...
			<i style='color: #333; float: left; padding-right: 10%'>MagiSide</i>
				...
				<div class="row" style='background-color:silver;' >
				  ...
				  <div class='col-md-9' style='padding-top:0px; background-color:white;'> <!-- right side with products -->
					...
					echo "<img src='$imagelink'   alt='image' width='100%' />";
								...
								?>
										<div class='col-md-4' style='padding:10px'> <!-- product 1 to 6 -->
										<img src='images/img2.jpg' width='100%' alt='Image 1'  />
										
										<button>View Details</button> <button>Add to cart</button>
										</div>
										
										<div class='col-md-4' style='padding:10px'> <!-- product 1 to 6 -->
										<img src='images/img3.jpg' width='100%' alt='Image 1'  />
										
										<button>View Details</button> <button>Add to cart</button>
										</div>
										
										<div class='col-md-4' style='padding:10px'> <!-- product 1 to 6 -->
										<img src='images/img4.jpg' width='100%' alt='Image 1'  />
				...
				<div class="row" style='padding-top:50px;'>
							<div class='col-md-4' style='padding:10px'> <!-- product 1 to 6 -->
							<img src='images/img5.jpg' width='100%' alt='Image 1'  />
							
							<button>View Details</button> <button>Add to cart</button>
							</div>
							
							<div class='col-md-4' style='padding:10px'> <!-- product 1 to 6 -->
							<img src='images/img6.jpg' width='100%' alt='Image 1'  />
							
							<button>View Details</button> <button>Add to cart</button>
							</div>
							
							<div class='col-md-4' style='padding:10px'> <!-- product 1 to 6 -->
							<img src='images/img7.jpg' width='100%' alt='Image 1'  />
